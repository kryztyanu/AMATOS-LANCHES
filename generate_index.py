...
<script>
    ...
    const ingredientesData = [
        { name: 'Camarão', extra: '+ R$ 5,00', price: 5, img: 'https://i.ibb.co/ycMNTvrh/image.png' },
        { name: 'Carne Moída', extra: '', price: 0, img: 'https://i.ibb.co/GfZXJ6TQ/image.png' },
        { name: 'Atum', extra: '', price: 0, img: 'https://i.ibb.co/Xk7g1kZJ/image.png' },
        { name: 'Bacon', extra: '', price: 0, img: 'https://i.ibb.co/LzHhWShM/image.png' },
        { name: 'Calabresa', extra: '', price: 0, img: 'https://i.ibb.co/nWnSp5q/image.png' },
        { name: 'Presunto', extra: '', price: 0, img: 'https://i.ibb.co/5hWgd7PW/image.png' },
        { name: 'Queijo Mussarella', extra: '', price: 0, img: 'https://i.ibb.co/5X6jLGyr/image.png' }
    ];

    const temperosData = [
        { name: 'Tomate', img: 'https://i.ibb.co/zTTsWzn5/image.png' },
        { name: 'Cebola', img: 'https://i.ibb.co/4ZKkQq3b/CEBOLA.png' },
        { name: 'Salsa', img: 'https://i.ibb.co/r2YCS5BJ/image.png' },
        { name: 'Pimentão', img: 'https://i.ibb.co/DDVYn2J7/image.png' },
        { name: 'Coentro', img: 'https://i.ibb.co/QFS7J7xy/image.png' },
        { name: 'Cebolinha', img: 'https://i.ibb.co/FkHNffdR/image.png' },
        { name: 'Alho', img: 'https://i.ibb.co/7JY7DHSG/ALHO.png' },
        { name: 'Passas', img: 'https://i.ibb.co/NddmmMP6/PASSAS.png' },
        { name: 'Azeitona', img: 'https://i.ibb.co/FbRBqNjT/AZEITONA.png' },
        { name: 'Ervilha', img: 'https://i.ibb.co/5hGr0HMQ/ERVILHA.png' },
        { name: 'Milho', img: 'https://i.ibb.co/DHKh3CKK/image.png' },
        { name: 'Orégano', img: 'https://i.ibb.co/PztpDgLn/image.png' },
        { name: 'Pimenta Calabresa', img: 'https://i.ibb.co/FkPswr8t/image.png' }
    ];
