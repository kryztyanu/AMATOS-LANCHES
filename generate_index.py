...
<script>
    ...
    function renderMacarraoModal() {
        ...
        ingredientesData.forEach(ing => {
            ...
            div.innerHTML = `
                <div style="display: flex; align-items: center; gap: 10px;">
                    ${ing.img ? `<img src="${ing.img}" referrerpolicy="no-referrer" style="width: 40px; height: 40px; object-fit: cover; border-radius: 6px;">` : ''}
                    <div>
        ...
        temperosData.forEach(t => {
            ...
            div.innerHTML = `
                <div style="display: flex; align-items: center; gap: 10px;">
                    ${t.img ? `<img src="${t.img}" referrerpolicy="no-referrer" style="width: 40px; height: 40px; object-fit: cover; border-radius: 6px;">` : ''}
