...
<script>
    ...
    const ingredientesData = [
        { name: 'Camarão', extra: '+ R$ 5,00', price: 5 },
        { name: 'Carne Moída', extra: '', price: 0 },
        { name: 'Atum', extra: '', price: 0 },
        { name: 'Bacon', extra: '', price: 0 },
        { name: 'Calabresa', extra: '', price: 0 },
        { name: 'Presunto', extra: '', price: 0 },
        { name: 'Queijo Mussarella', extra: '', price: 0 }
    ];
