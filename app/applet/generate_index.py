...
sandwiches = [
    ...
    {"id": "sand_4", "name": "Misto Burguer", "category": "SANDUÍCHES", "description": "pão, hambúrguer bovino, queijo e presunto", "price": 12.0, "priceText": "R$ 12,00"},
    ...
    {"id": "sand_7", "name": "Misto Frango", "category": "SANDUÍCHES", "description": "pão, queijo, presunto e frango", "price": 15.0, "priceText": "R$ 15,00"},
    ...
    {"id": "sand_12", "name": "X-Frango", "category": "SANDUÍCHES", "description": "pão, frango, queijo e salada", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "sand_13", "name": "X-Frango Tudo", "category": "SANDUÍCHES", "description": "pão, frango, queijo, ovo, bacon, calabresa e salada", "price": 20.0, "priceText": "R$ 20,00", "isPopular": True},
    {"id": "sand_14", "name": "Amatos Frango", "category": "SANDUÍCHES", "description": "pão, filé de frango, queijo coalho e salada", "price": 21.0, "priceText": "R$ 21,00"},
    {"id": "sand_15", "name": "Amatos Alcatra", "category": "SANDUÍCHES", "description": "pão, filé de alcatra, queijo coalho e salada", "price": 23.0, "priceText": "R$ 23,00", "isPopular": True},
    {"id": "sand_16", "name": "Amatos Bacon", "category": "SANDUÍCHES", "description": "pão, hambúrguer bovino, bacon, cheddar e salada", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "sand_17", "name": "X-Bacon", "category": "SANDUÍCHES", "description": "pão, bacon, queijo e salada", "price": 17.0, "priceText": "R$ 17,00"},
    {"id": "sand_18", "name": "X-Bacon Egg", "category": "SANDUÍCHES", "description": "pão, bacon, queijo, ovo e salada", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "sand_19", "name": "X-Bacon Frango", "category": "SANDUÍCHES", "description": "pão, bacon, queijo, frango e salada", "price": 20.0, "priceText": "R$ 20,00"},
    {"id": "sand_20", "name": "X-Calabresa", "category": "SANDUÍCHES", "description": "pão, hambúrguer, queijo, calabresa e salada", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "sand_21", "name": "Mistão", "category": "SANDUÍCHES", "description": "pão, filé de alcatra, filé de frango, calabresa, queijo, presunto e salada", "price": 28.0, "priceText": "R$ 28,00", "isPopular": True},
    ...
    {"id": "sand_27", "name": "X-Tudo 1", "category": "SANDUÍCHES", "description": "pão, hambúrguer, queijo, presunto, ovo, bacon, calabresa e salada", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "sand_28", "name": "X-Tudo 2", "category": "SANDUÍCHES", "description": "pão, 2 hambúrgueres, queijo, presunto, ovo, bacon, calabresa e salada", "price": 17.0, "priceText": "R$ 17,00"},
    {"id": "sand_29", "name": "X-Tudo 3", "category": "SANDUÍCHES", "description": "pão, 3 hambúrgueres, queijo, presunto, ovo, bacon, calabresa e salada", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "sand_30", "name": "X-Tudo 4", "category": "SANDUÍCHES", "description": "pão, 4 hambúrgueres, queijo, presunto, ovo, bacon, calabresa e salada", "price": 19.0, "priceText": "R$ 19,00", "isPopular": True},
    {"id": "sand_31", "name": "X-Frango Calabresa", "category": "SANDUÍCHES", "description": "pão, frango, calabresa, queijo e salada", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "sand_32", "name": "X-Frango Bacon", "category": "SANDUÍCHES", "description": "pão, frango, bacon, queijo e salada", "price": 17.0, "priceText": "R$ 17,00"},
    {"id": "sand_33", "name": "X-Gostoso Frango", "category": "SANDUÍCHES", "description": "pão, frango, hambúrguer bovino, queijo e tomate", "price": 17.0, "priceText": "R$ 17,00"},
    {"id": "sand_34", "name": "X-Churrasco 1", "category": "SANDUÍCHES", "description": "pão francês, filé bovino, queijo e cebola", "price": 20.0, "priceText": "R$ 20,00"},
    {"id": "sand_35", "name": "X-Churrasco 2", "category": "SANDUÍCHES", "description": "pão francês, filé bovino, queijo, bacon, ovo, cebola e salada", "price": 27.0, "priceText": "R$ 27,00"},
    {"id": "sand_36", "name": "X-Light", "category": "SANDUÍCHES", "description": "pão, frango, queijo e salada", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "sand_37", "name": "X-Gordo", "category": "SANDUÍCHES", "description": "pão, calabresa, 2 hambúrgueres, ovo, cebola, tomate e orégano", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "sand_38", "name": "X-Especial", "category": "SANDUÍCHES", "description": "pão, frango, hambúrguer, queijo, presunto, ovo, bacon e calabresa", "price": 21.0, "priceText": "R$ 21,00"},
    {"id": "sand_39", "name": "X-Frango com Cheddar", "category": "SANDUÍCHES", "description": "pão, frango, queijo, cheddar e salada", "price": 18.0, "priceText": "R$ 18,00"}
]

pastels = [
    {"id": "past_1", "name": "Barroso", "category": "PASTÉIS", "description": "frango com queijo", "price": 17.0, "priceText": "R$ 17,00"},
    {"id": "past_2", "name": "Palmeiras", "category": "PASTÉIS", "description": "frango com presunto", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "past_3", "name": "Bulevar", "category": "PASTÉIS", "description": "frango com cheddar", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_4", "name": "Itaperi", "category": "PASTÉIS", "description": "frango com catupiry", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_5", "name": "Mondubim", "category": "PASTÉIS", "description": "frango com bacon", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "past_6", "name": "Itaitinga", "category": "PASTÉIS", "description": "frango, queijo e presunto", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "past_7", "name": "Estrada do Fio", "category": "PASTÉIS", "description": "carne com queijo", "price": 17.0, "priceText": "R$ 17,00"},
    {"id": "past_8", "name": "Messejana", "category": "PASTÉIS", "description": "carne, queijo e ovo", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "past_9", "name": "Parque Iracema", "category": "PASTÉIS", "description": "carne moída", "price": 15.0, "priceText": "R$ 15,00"},
    {"id": "past_10", "name": "Pedras", "category": "PASTÉIS", "description": "carne do sol com queijo", "price": 25.0, "priceText": "R$ 25,00", "isPopular": True},
    {"id": "past_11", "name": "Caucaia", "category": "PASTÉIS", "description": "queijo, presunto e ovo", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "past_12", "name": "Av. Perimental", "category": "PASTÉIS", "description": "presunto com milho", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "past_13", "name": "Conj. Palmeiras", "category": "PASTÉIS", "description": "presunto e queijo", "price": 14.0, "priceText": "R$ 14,00"},
    {"id": "past_14", "name": "Santa Filomena", "category": "PASTÉIS", "description": "atum com palmito", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_15", "name": "São Cristóvão", "category": "PASTÉIS", "description": "presunto e queijo", "price": 14.0, "priceText": "R$ 14,00"},
    {"id": "past_16", "name": "Pq. 2 irmãos", "category": "PASTÉIS", "description": "carne do sol, banana da terra e queijo", "price": 30.0, "priceText": "R$ 30,00", "isPopular": True},
    {"id": "past_17", "name": "Luiz Gonzaga", "category": "PASTÉIS", "description": "atum com queijo", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "past_18", "name": "Parquelândia", "category": "PASTÉIS", "description": "calabresa com queijo", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "past_19", "name": "Bairro Novo", "category": "PASTÉIS", "description": "calabresa, carne, queijo, presunto e frango", "price": 20.0, "priceText": "R$ 20,00"},
    {"id": "past_20", "name": "Ancuri", "category": "PASTÉIS", "description": "filé de alcatra ou maminha com queijo", "price": 22.0, "priceText": "R$ 22,00"},
    {"id": "past_21", "name": "Jangurussú", "category": "PASTÉIS", "description": "bacon com queijo", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "past_22", "name": "Vl. Manoel Sátiro", "category": "PASTÉIS", "description": "bacon, carne e queijo", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_23", "name": "Sabiaguaba", "category": "PASTÉIS", "description": "camarão com queijo", "price": 25.0, "priceText": "R$ 25,00"},
    {"id": "past_24", "name": "Parangaba", "category": "PASTÉIS", "description": "camarão com cheddar", "price": 25.0, "priceText": "R$ 25,00"},
    {"id": "past_25", "name": "Maraponga", "category": "PASTÉIS", "description": "camarão com cream cheese", "price": 27.0, "priceText": "R$ 27,00", "isPopular": True},
    {"id": "past_26", "name": "Granja Lisboa", "category": "PASTÉIS", "description": "camarão com catupiry", "price": 26.0, "priceText": "R$ 26,00"},
    {"id": "past_27", "name": "Praia do Futuro", "category": "PASTÉIS", "description": "lombinho com queijo e milho", "price": 20.0, "priceText": "R$ 20,00"},
    {"id": "past_28", "name": "Violeta", "category": "PASTÉIS", "description": "lombinho com cream cheese", "price": 21.0, "priceText": "R$ 21,00"},
    {"id": "past_29", "name": "Zé Walter", "category": "PASTÉIS", "description": "queijo", "price": 30.0, "priceText": "R$ 30,00"},
    {"id": "past_30", "name": "Lagoa Redonda", "category": "PASTÉIS", "description": "queijo com goiabada", "price": 15.0, "priceText": "R$ 15,00"},
    {"id": "past_31", "name": "Curió", "category": "PASTÉIS", "description": "presunto, queijo, ovo, azeitona e cebola", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_32", "name": "Damas", "category": "PASTÉIS", "description": "frango, passas, milho e ervilha", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_33", "name": "Varjota", "category": "PASTÉIS", "description": "carne, passas, pim. malagueta ou pim. calabresa", "price": 18.0, "priceText": "R$ 18,00"},
    {"id": "past_34", "name": "Meireles", "category": "PASTÉIS", "description": "brocólis, palmito, tomate, cereja e peito de peru", "price": 20.0, "priceText": "R$ 20,00"},
    {"id": "past_35", "name": "B. do Ceará", "category": "PASTÉIS", "description": "carne e frango", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_36", "name": "Passare (Pastel Japonês)", "category": "PASTÉIS", "description": "camarão, kane kamma e cream cheese", "price": 30.0, "priceText": "R$ 30,00"},
    {"id": "past_37", "name": "Vila Velha", "category": "PASTÉIS", "description": "ovo, queijo e presunto", "price": 16.0, "priceText": "R$ 16,00"},
    {"id": "past_38", "name": "Pirambu", "category": "PASTÉIS", "description": "frango, milho e ervilha", "price": 17.0, "priceText": "R$ 17,00"},
    {"id": "past_39", "name": "Aldeota", "category": "PASTÉIS", "description": "carne do sol, queijo e purê de aipim", "price": 30.0, "priceText": "R$ 30,00", "isPopular": True},
    {"id": "past_40", "name": "Castelo Encantado", "category": "PASTÉIS", "description": "frango com requeijão cremoso", "price": 19.0, "priceText": "R$ 19,00"},
    {"id": "past_41", "name": "Caça e Pesca", "category": "PASTÉIS", "description": "carne do sol, macaxeira frita e queijo coalho", "price": 25.0, "priceText": "R$ 25,00"}
]

snacks = [
    {"id": "pet_1", "name": "Caixa da Felicidade", "category": "PETISCOS", "description": "(Batata Frita, Contra Filé, Toscana, Asinha, Coxinha da Asa, Arroz à Grega, Salada de Maionese, Baião Cremoso, Farofa e Vinagrete)", "price": 100.0, "priceText": "R$ 100,00", "isPopular": True},
    {"id": "pet_2", "name": "Baião Cremoso", "category": "PETISCOS", "description": "(acompanha: Carne do sol)", "price": 55.0, "priceText": "R$ 55,00"},
    ...
    {"id": "pet_9", "name": "Bobó de Camarão", "category": "PETISCOS", "description": "(porção única)", "price": 70.0, "priceText": "R$ 70,00"},
    {"id": "pet_10", "name": "Batata Frita Simples", "category": "PETISCOS", "description": "(porção tradicional)", "price": 25.0, "priceText": "R$ 25,00"},
    {"id": "pet_11", "name": "Batata Frita com Calabresa", "category": "PETISCOS", "description": "(acompanha calabresa fatiada)", "price": 28.0, "priceText": "R$ 28,00"},
    {"id": "pet_12", "name": "Batata Frita com Bacon e Cheddar", "category": "PETISCOS", "description": "(coberta com molho cheddar e cubos de bacon)", "price": 30.0, "priceText": "R$ 30,00", "isPopular": True}
]
